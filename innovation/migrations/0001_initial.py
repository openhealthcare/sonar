...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Item'
        db.create_table('innovation_item', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ...
        db.send_create_signal('innovation', ['Item'])
        ...
        # Adding model 'Vote'
        db.create_table('innovation_vote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target_id', self.gf('django.db.models.fields.IntegerField')()),
            ('target_type', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('innovation', ['Vote'])

        # Adding unique constraint on 'Vote', fields ['target_id', 'target_type']
        db.create_unique('innovation_vote', ['target_id', 'target_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['target_id', 'target_type']
        db.delete_unique('innovation_vote', ['target_id', 'target_type'])

        # Deleting model 'Evidence'
        db.delete_table('innovation_evidence')

        # Deleting model 'Item'
        db.delete_table('innovation_item')
        ...
        # Deleting model 'Vote'
        db.delete_table('innovation_vote')
    ...
    models = {
        ...
        'innovation.item': {
            ...
            'evidence': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['innovation.Evidence']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'})
        },
        'innovation.specialisation': {
            'Meta': {'ordering': "['name']", 'object_name': 'Specialisation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['innovation.Item']"}),
